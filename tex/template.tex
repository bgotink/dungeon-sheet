...
% lines
\draw[line width=1.5pt, shorten <= \dndhoroffset, shorten >= \dndhoroffset] (o) -- (a);
\draw[line width=1.5pt, shorten <= \dndveroffset, shorten >= \dndveroffset] (a) -- (b);
\draw[line width=1.5pt, shorten <= \dndhoroffset, shorten >= \dndhoroffset] (b) -- (c);
\draw[line width=1.5pt, shorten <= \dndveroffset, shorten >= \dndveroffset] (c) -- (o);

% top left corner
\draw[line width=1.5pt]
	($ (o) + (\dndhoroffset, 0) + (1.5pt, 0) $)
	-- ($ (o) + (\dndhoroffset, 0) $)
	arc (0:-90:\dndhoroffset)
	-- ($ (o) + (-\dndhoroffset/4,-\dndveroffset/2)$)
	to[in=85,out=290] ($ (o) + (0,-\dndveroffset) $)
	-- ($ (o) + (0,-\dndveroffset) + (0, -1.5pt) $)
;
